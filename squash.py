...
BRIQUE_LARGEUR = 60
BRIQUE_HAUTEUR = 20
BRIQUE_POSITION = (FENETRE_LARGEUR / 4, FENETRE_HAUTEUR / 3)
...
def anime():
    ...
    test_collision((BRIQUE_POSITION, (BRIQUE_LARGEUR, BRIQUE_HAUTEUR)), True)
...
def dessine_court():
    ...
    fenetre.blit(marquoir, (FENETRE_LARGEUR // 8, FENETRE_HAUTEUR // 10))
    ...
    pygame.draw.rect(fenetre, BEIGE, (BRIQUE_POSITION, (BRIQUE_LARGEUR, BRIQUE_HAUTEUR)))
...
# rect represente un rectangle ((gauche, haut), (largeur, hauteur))
def test_collision(rect, brique = False):
    global score
